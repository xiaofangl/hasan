      ...
      <el-card class="box-card" style="width: 100%">
        ...
        <div>
          <el-form :model="uploadForm" ref="uploadForm" label-width="140px" :rules="uploadForms">
            <el-form-item label="文件名称" prop="name">
              ...
              <span v-else>
                  ...
                  <el-button size="small" type="primary"
                             @click="no_permission = true">点击上传</el-button>
                <!--<div slot="tip" class="el-upload__tip">只能上传jpg/png文件，且不超过500kb</div>-->
                </span>
            </el-form-item>
            ...
            <el-form-item>
              <template v-if="isdns_admin">
                <el-button type="primary" @click="submitUload('updateForm')">立即同步</el-button>
              </template>
              <template v-else>
                <el-button type="primary" @click="no_permission = true">立即同步</el-button>
              </template>
        ...
        <div>
          <el-form :model="ruleForm" ref="ruleForm" label-width="140px" :rules="ruleForms">
            <el-form-item label="文件名称" prop="name">
              ...
              <template v-else>
                <el-input v-model.trim="ruleForm.name" placeholder="请输入zone文件名称如：xxx.mmm.zone"
                          @click="no_permission = true"></el-input>
              </template>
            ...
            <el-form-item>
              ...
              <template v-else>
                <el-button type="primary" @click="no_permission = true">立即创建</el-button>
              </template>
        ...
        <div>
          <el-form :model="delForm" ref="delForm" label-width="140px" :rules="delForms">
            ...
            <el-form-item>
              ...
              <template v-else>
                <el-button type="primary" @click="no_permission = true">立即删除</el-button>
              </template>
...
//          'ttl': ''
    ...
    created: function () {
      this.bus.$on('isdns_admin', function (val) {
        console.log('val', val);
        this.isdns_admin = val;
      }.bind(this));
    },
    activated: function () {
      this.get_all_list();
