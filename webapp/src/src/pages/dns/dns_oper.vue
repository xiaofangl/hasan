      ...
      <div class="tabs_class" v-for="item in res_data">
        ...
        <el-card class="box-card">
          <div slot="header" class="clearfix">
            ...
            <span v-else><el-button style="float: right; padding: 3px 0" type="text"
                                    @click="no_permission = true">添加解析</el-button>
            </span>
            ...
            <el-table :data="item[1]" style="width: 100%" height="250">
              ...
              <el-table-column label="操作">
                <template slot-scope="scope">
                  ...
                  <span v-else>
                    <el-button @click="no_permission = true" type="text" size="small">删除</el-button>
                  </span>
                </template>
              </el-table-column>
            </el-table>
